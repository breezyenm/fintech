...
import 'package:qwid/screens/home/pages/wallet/transactions/send_money/internal_transfer.dart';

class InternalTransferSheet extends GeneralSheet {
  InternalTransferSheet({Key? key, required BuildContext context})
      : super(
          key: key,
          subtitle: 'Enter amount and select currency',
          title: 'Internal Transfer',
          buttonText: 'Choose beneficiary',
          body: [
